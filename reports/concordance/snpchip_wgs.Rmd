...
p1 <- counts_gt1 %>%
  ...
  ggtitle(glue::glue("SNPchip GT counts per chromosome for {nrow(count(counts_gt1, Sample))} samples."))
...
p2 <- counts_gt1 %>%
  ...
  ggtitle(glue::glue("SNPchip GT counts for {nrow(count(counts_gt1, Sample))} samples."))
