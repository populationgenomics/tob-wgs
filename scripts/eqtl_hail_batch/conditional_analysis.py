...
def calculate_residual_df(residual_path: str, significant_snps_path: str, output_path: str) -> str:
...
def main(
    ...
    for iteration in range(2, iterations + 2):
        ...
        previous_residual_path = calc_resid_df_job.call(
            ...
            output_path=os.path.join(output_prefix, f'round{iteration}_residual_results.csv')
        )
